...
public class TitleReplacer implements IslandFeature {
    ...
    public void onKitSelectionPhase(KitSelectionEvent event) {
        ...
        MutableText newTitle = parseColorCodes((String) pickRandom(config.battleBox_titleReplacements.kitSelectionTitles()));
    ...
    public void onRoundWin(RoundWinEvent event) {
        ...
        MutableText newTitle = parseColorCodes((String) pickRandom(config.battleBox_titleReplacements.roundVictoryTitles()));
    ...
    public void onRoundLost(RoundLoseEvent event) {
        ...
        MutableText newTitle = parseColorCodes((String) pickRandom(config.battleBox_titleReplacements.roundDefeatTitles()));
    ...
    public void onTeamVictory(TeamVictoryEvent event) {
        ...
        MutableText newTitle = parseColorCodes((String) pickRandom(config.skyBattle_titleReplacements.teamVictoryTitles()));
    ...
    public void onTeamDefeat(TeamDefeatEvent event) {
        ...
        MutableText newTitle = parseColorCodes((String) pickRandom(config.skyBattle_titleReplacements.teamEliminationTitles()));
    ...
    public void onRoundFinish(RoundFinishEvent event) {
        ...
        MutableText newTitle = parseColorCodes((String) pickRandom(config.tgttos_titleReplacements.whackedTitles()));
    ...
    public void onTimeSkip(TimeSkipEvent event) {
        ...
        MutableText newTitle = parseColorCodes((String) pickRandom(config.tgttos_titleReplacements.timeSkipTitles()));
